const translations = {
    ko: {
        ...
        noApiKey: "OpenAI API Key를 먼저 설정해주세요.",
        noGeminiApiKey: "Gemini API Key를 먼저 설정해주세요.",
    ...
    en: {
        ...
        noApiKey: "Please set your OpenAI API Key first.",
        noGeminiApiKey: "Please set your Gemini API Key first.",
